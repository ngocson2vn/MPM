...
template<typename T>void operator>>(const string&s,T&t){if(s.size()>0){istringstream i(s);i>>t;}}
...
struct UVF   :public timeIntSC{shapeSC&sh;void advance(patch&pch);UVF   (shapeSC&s):sh(s){}};
